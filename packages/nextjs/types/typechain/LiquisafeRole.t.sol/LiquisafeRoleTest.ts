...
export interface LiquisafeRoleTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "btcToken"
...
export interface LiquisafeRoleTest extends BaseContract {
  connect(runner?: ContractRunner | null): LiquisafeRoleTest;
  waitForDeployment(): Promise<this>;

  interface: LiquisafeRoleTestInterface;
