...
export interface LiquisafeManagementTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "btcToken"
  ...
  encodeFunctionData(
    functionFragment: "test_AddFactory",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_AddManager",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface LiquisafeManagementTest extends BaseContract {
  connect(runner?: ContractRunner | null): LiquisafeManagementTest;
  waitForDeployment(): Promise<this>;

  interface: LiquisafeManagementTestInterface;
  ...
  test_AddFactory: TypedContractMethod<[], [void], "nonpayable">;

  test_AddManager: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "test_AddFactory"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "test_AddManager"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
