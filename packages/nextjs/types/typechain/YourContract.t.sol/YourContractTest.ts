...
export interface YourContractTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(
    functionFragment: "testMessageOnDeployment",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSetNewMessage",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "yourContract",
    values?: undefined
  ): string;
...
export interface YourContractTest extends BaseContract {
  connect(runner?: ContractRunner | null): YourContractTest;
  ...
  testMessageOnDeployment: TypedContractMethod<[], [void], "view">;

  testSetNewMessage: TypedContractMethod<[], [void], "nonpayable">;

  yourContract: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "testMessageOnDeployment"
  ): TypedContractMethod<[], [void], "view">;
  getFunction(
    nameOrSignature: "testSetNewMessage"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "yourContract"
  ): TypedContractMethod<[], [string], "view">;
